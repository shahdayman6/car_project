...
class SparePartsSeeder extends Seeder
{
    ...
    public function run(): void
    {
     ...
     [
        ...
        'images' => json_encode(['images/spare_parts/Turbocharger.png']),
        'created_at' => now(),
        'updated_at' => now(),
     ],
     [
        ...
        'images' => json_encode(['images/spare_parts/Car Battery.png']),
        'created_at' => now(),
        'updated_at' => now(),
     ],
     [
        ...
        'images' => json_encode(['images/spare_parts/Oil Filter.png']),
        'created_at' => now(),
        'updated_at' => now(),
     ],
    ]);
